...
module.exports = async function (context, req) {
  try {
    ...
    catch (e) { context.res = { status: 500, jsonBody: { error: "mssql module not installed", detail: String(e) } }; return; }

    if (!process.env.SQL_CONNECTION) {
      context.res = { status: 500, jsonBody: { error: "SQL_CONNECTION not set on Static Web App" } };
      return;
    }
    ...
    context.res = { status: 200, jsonBody: { ok: r.recordset[0].ok } };
  } catch (e) {
    context.log.error(e);
